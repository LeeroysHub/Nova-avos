...
#ifdef CONFIG_CP28606
// ************************************************
//
//	Windows 28606 - ISO/IEC 8859-16 - Latin-10 or South-Eastern European
//
// ************************************************
static const wchar cp28606_unicode[] =
{
...
static int cp2uc_28606( const unsigned char *t, wchar *uc )
{
	int cp = *t;
	if( cp >= 0xA0 ) {
		*uc = cp28606_unicode[ cp - 0xA0 ];
		return 1;
	}
	return 0;
}
