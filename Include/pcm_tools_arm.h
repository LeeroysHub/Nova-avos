...
#ifndef _PCM_TOOLS_ARM_H
#define _PCM_TOOLS_ARM_H
...
static inline long long pcm_s16le_squaresum( const SHORT* buf, int samples )
{
	...
	/*
	 * this two-register 64bit stuff is a bit hairy to code
	 * in inline assembly. there's no documentation awailable,
	 * so you have to grep the machine description file for
	 * "smlalbb" and figure out how to translate the .md syntax
	 * into inline assembly constraints.
	 */
