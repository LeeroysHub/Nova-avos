...
DLHELPER_REG(DLHELPER_NOCRIT, ctor,
	void, (void *, int, unsigned int, int, int, int, unsigned int, void (*)(int, void *, void *), void *, int, int, int, void *, int, int, void *, int),
	...
	"_ZN7android10AudioTrackC1E19audio_stream_type_tj14audio_format_tjj20audio_output_flags_tPFviPvS4_ES4_jiNS0_13transfer_typeEPK20audio_offload_info_tiiPK18audio_attributes_tb",
	"_ZN7android10AudioTrackC1E19audio_stream_type_tj14audio_format_tjj20audio_output_flags_tPFviPvS4_ES4_jiNS0_13transfer_typeEPK20audio_offload_info_tiiPK18audio_attributes_t");

DLHELPER_REG(DLHELPER_NOCRIT, ctor_legacy,
...
DLHELPER_REG(DLHELPER_CRIT, write,
	int, (void *, void  const*, unsigned int, int),
...
DLHELPER_REG(DLHELPER_NOCRIT, initCheck,
	int, (void *),
	"_ZNK7android10AudioTrack9initCheckEv");

DLHELPER_REG(DLHELPER_NOCRIT, setVolume,
	int, (void *, float, float),
	"_ZN7android10AudioTrack9setVolumeEff");

DLHELPER_REG(DLHELPER_NOCRIT, isDirect,
	int, (void*),
	"_ZNK7android10AudioTrack8isDirectEv");
