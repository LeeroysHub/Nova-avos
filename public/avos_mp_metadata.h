...
enum {
	...
	AVOS_MP_METADATA_AUDIO_TRACK_LANGUAGE		= 7,
	AVOS_MP_METADATA_AUDIO_TRACK_MAX			= 8,

	AVOS_MP_METADATA_SUBTITLE_TRACK			= 30000,
	AVOS_MP_METADATA_SUBTITLE_TRACK_NAME		= 0,
	AVOS_MP_METADATA_SUBTITLE_TRACK_PATH		= 1,
	AVOS_MP_METADATA_SUBTITLE_TRACK_IS_GFX		= 2,
	AVOS_MP_METADATA_SUBTITLE_TRACK_FORMAT		= 3,
	AVOS_MP_METADATA_SUBTITLE_TRACK_LANGUAGE	= 4,
	AVOS_MP_METADATA_SUBTITLE_TRACK_MAX			= 5,
};
